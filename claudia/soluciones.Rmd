...
**Caso favorable:**
  ...
  - Criterio de Wald
```{r}
wald_fav = criterio.Wald(tabla1, T)
```
  Con este criterio se elige la alternativa 2

  - Criterio Optimista
```{r}
opt_fav = criterio.Optimista(tabla1, T)
```
  Con este criterio se elige la alternativa 2

  - Criterio de Hurwicz
```{r}
hurwicz_fav = criterio.Hurwicz(tabla1, alfa = 0.4, T)
```
   Con este criterio se elige la alternativa 2

  - Criterio de Savage
```{r}
savage_fav = criterio.Savage(tabla1, T)
```
   Con este criterio se elige la alternativa 2

  - Criterio de Laplace
```{r}
laplace_fav = criterio.Laplace(tabla1, T)
```
   Con este criterio se elige la alternativa 2

  - Criterio Punto Ideal
```{r}
puntoIdeal_fav = criterio.PuntoIdeal(tabla1, T)
```
  Con este criterio se elige la alternativa 2
...
**Caso desfavorable:**
  ...
  - Criterio de Wald
```{r}
wald_desf = criterio.Wald(tabla1, F)
```
   Con este criterio se elige la alternativa 1
  
  - Criterio Optimista
```{r}
opt_desf = criterio.Optimista(tabla1, F)
```
   Con este criterio se elige la alternativa 1

  - Criterio de Hurwicz
```{r}
hurwicz_desf = criterio.Hurwicz(tabla1, alfa = 0.4, F)
```
   Con este criterio se elige la alternativa 1

  - Criterio de Savage
```{r}
savage_desf = criterio.Savage(tabla1, F)
```
  Con este criterio se elige la alternativa 1

  - Criterio de Laplace
```{r}
laplace_desf = criterio.Laplace(tabla1, F)
```
  Con este criterio se elige la alternativa 1

  - Criterio Punto Ideal
```{r}
puntoideal_desf = criterio.PuntoIdeal(tabla1, F)
```
  Con este criterio se elige la alternativa 1
